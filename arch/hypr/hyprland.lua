...
hl.bind(
	"SHIFT + " .. mainMod .. " + S",
	hl.dsp.exec_cmd(
		'hyprctl --batch "dispatch togglefloating active; dispatch resizeactive exact 30% 30%; dispatch moveactive exact 69% 5%; dispatch pin active"'
	)
)
...
hl.bind(mainMod .. " + 1", hl.dsp.focus({ workspace = tab_one }))
hl.bind(mainMod .. " + 2", hl.dsp.focus({ workspace = tab_two }))
hl.bind(mainMod .. " + 3", hl.dsp.focus({ workspace = tab_three }))
hl.bind(mainMod .. " + 4", hl.dsp.focus({ workspace = tab_four }))
hl.bind(mainMod .. " + 5", hl.dsp.focus({ workspace = tab_five }))
hl.bind(mainMod .. " + 6", hl.dsp.focus({ workspace = tab_six }))

-- Move Window to Workspace
hl.bind("SHIFT + " .. mainMod .. " + 1", hl.dsp.window.move({ workspace = tab_one }))
hl.bind("SHIFT + " .. mainMod .. " + 2", hl.dsp.window.move({ workspace = tab_two }))
hl.bind("SHIFT + " .. mainMod .. " + 3", hl.dsp.window.move({ workspace = tab_three }))
hl.bind("SHIFT + " .. mainMod .. " + 4", hl.dsp.window.move({ workspace = tab_four }))
hl.bind("SHIFT + " .. mainMod .. " + 5", hl.dsp.window.move({ workspace = tab_five }))
hl.bind("SHIFT + " .. mainMod .. " + 6", hl.dsp.window.move({ workspace = tab_six }))

-- Move Window to Workspace (no follow)
hl.bind("ALT + 1", hl.dsp.window.move({ workspace = tab_one, follow = false }))
hl.bind("ALT + 2", hl.dsp.window.move({ workspace = tab_two, follow = false }))
hl.bind("ALT + 3", hl.dsp.window.move({ workspace = tab_three, follow = false }))
hl.bind("ALT + 4", hl.dsp.window.move({ workspace = tab_four, follow = false }))
hl.bind("ALT + 5", hl.dsp.window.move({ workspace = tab_five, follow = false }))
hl.bind("ALT + 6", hl.dsp.window.move({ workspace = tab_six, follow = false }))
